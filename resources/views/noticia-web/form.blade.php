                        ...
                        <div class="form-group m-3 w-70">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-6">
                                    <div class="form-group">
                                        <label>Retorno</label>
                                        <input type="text" class="form-control valor_milhar" name="nu_valor" id="nu_valor" placeholder="Retorno" value="{{ ($noticia and $noticia->nu_valor) ? $noticia->nu_valor : old('nu_valor') }}">
                                    </div>                                    
                                </div>
                            </div>
                            <div class="row">
