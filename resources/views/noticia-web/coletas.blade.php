...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="col-md-12">
                <p class="text-danger mb-0">Base de todas as notícias cadastradas no sistema, sem considerar vinculação com clientes.</p>
            </div>
            <div class="row mb-0">
                <div class="col-lg-12 col-sm-12 mb-0 mt-0">
                    {!! Form::open(['id' => 'frm_social_search', 'class' => 'form-horizontal', 'url' => ['noticia/web/coletas']]) !!}
