                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-sm-12">
                                        <h6><strong>{{ $noticia->titulo }}</strong></h6>
                                        <p>{{ ($noticia->emissora) ? $noticia->emissora->nome_emissora : 'Não identificada' }} - {{ \Carbon\Carbon::parse($noticia->dt_clipagem)->format('d/m/Y') }}</p>
                                        <p>
