    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-8">
                    <h4 class="card-title">
                        <i class="fa fa-newspaper-o ml-3"></i> Impresso 
                        <i class="fa fa-angle-double-right" aria-hidden="true"></i> Retorno de Mídia 
                    </h4>
                </div>
                <div class="col-md-4">
                    <a href="{{ url('noticias/impresso') }}" class="btn btn-info pull-right mr-3"><i class="fa fa-table"></i> Notícias</a>
                    <a href="{{ url('noticia/impresso/atualiza-retorno') }}" class="btn btn-primary pull-right" style="margin-right: 12px;"><i class="fa fa-dollar"></i> Atualizar Valores</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                        ...
                        <table id="" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @foreach($inconsistencias as $inconsistencia)
                                    <tr>
                                        <td><a title="Editar" href="{{ ($inconsistencia->nome ) ? url('fonte-impresso/'.$inconsistencia->id.'/editar') : '' }}" target="BLANK" class="text-info">{!! $inconsistencia->nome !!}</a></td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="pull-right">
                                                ...
                                                <a title="Editar" href="{{ url('noticia-impressa/'.$noticia->id.'/editar') }}" target="_BLANK" class="btn btn-primary btn-fill btn-icon btn-sm pull-right" style="border-radius: 20px;">
