            ...
            <div class="card-body">
                <div class="row mr-1 ml-1">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="form-check float-left mr-3">
                                    <label class="form-check-label mt-2">
                                        <input class="form-check-input" {{ ($cliente->fl_instagram) ? 'checked' : '' }} type="checkbox" name="fl_instagram" value="true">
                                        INSTAGRAM
                                        <span class="form-check-sign"></span>
                                    </label>
                                </div>
                                <div class="form-check float-left mr-3">
                                    <label class="form-check-label mt-2">
                                        <input class="form-check-input" {{ ($cliente->fl_facebook) ? 'checked' : '' }} type="checkbox" name="fl_facebook" value="true">
                                        FACEBOOK
                                        <span class="form-check-sign"></span>
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" name="hashtags" id="hashtags" rows="3">{{ $cliente->hashtags }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" name="list_keywords" id="list_keywords" rows="3">{{ $cliente->list_keywords }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <p class="mb-0 mt-3"><i class="fa fa-envelope"></i> Endereços Eletrônicos <span class="text-info">Informe os endereços separados por vírgula</span></p>
                                <div class="form-group">
