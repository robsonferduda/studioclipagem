                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-check float-left mr-3">
                                    <label class="form-check-label mt-2">
                                        <input class="form-check-input" type="checkbox" name="fl_texto_logo" value="true">
                                            TEXTO LOGO
                                        <span class="form-check-sign"></span>
                                    </label>
                                </div>                    
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="form-check float-left mr-3">
                                    <label class="form-check-label mt-2">
                                        <input class="form-check-input" {{  old('fl_linkedin') ? 'checked' : '' }} type="checkbox" name="fl_linkedin" value="true">
                                        LINKEDIN
                                        <span class="form-check-sign"></span>
                                    </label>
                                </div>
                                <div class="form-check float-left mr-3">
                                    <label class="form-check-label mt-2">
                                        <input class="form-check-input" {{  old('fl_twitter') ? 'checked' : '' }} type="checkbox" name="fl_twitter" value="true">
                                        TWITTER
                                        <span class="form-check-sign"></span>
                                    </label>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="form-check float-left mr-3">
                                    <label class="form-check-label mt-2">
                                        <input class="form-check-input" {{ old('fl_hashtag') ? 'checked' : '' }} type="checkbox" name="fl_hastag" value="true">
                                            COLETAR HASHTAGS
                                        <span class="form-check-sign"></span>
                                    </label>
                                </div>
