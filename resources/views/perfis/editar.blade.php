...
@section('content')
<div class="col-md-12">
    {!! Form::open(['id' => 'frm_social_search', 'url' => ['perfis', $role->id], 'method' => 'patch']) !!}
        <div class="card">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="display_name" id="display_name" placeholder="Nome" value="{{ $role->name }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Chave <span class="text-danger">Obrigatório</span></label>
                            <input type="text" class="form-control" name="name" id="name" placeholder="Chave" value="{{  $role->display_name }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Cor <span class="text-danger">Obrigatório, informar código hexadecimal</span></label>
                            <input type="text" class="form-control" name="display_color" id="display_color" placeholder="Cor" value="{{  $role->display_color }}">
                        </div>
                    </div>
                </div>  
                <div class="row">
