                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" name="dt_inicial" id="dt_inicial" placeholder="__/__/____" value="{{ $dt_inicial ?? '' }}">
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label>Data Final</label>
                                <input type="text" class="form-control datepicker" name="dt_final" id="dt_final" placeholder="__/__/____" value="{{ $dt_final ?? '' }}">
                            </div>
                        </div>                        
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control cliente" name="id_cliente" id="id_cliente" required>
                                    <option value="">Selecione um cliente para continuar</option>
                                    @foreach($clientes as $cli)
                                        <option value="{{ $cli->id }}">{{ $cli->nome }}</option>
                                    @endforeach
                                </select>
                                <small class="form-text text-muted">
                                    Selecione um cliente para carregar os filtros e permissões específicas.
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div id="tags-filtro-container" class="border rounded p-3" style="min-height: 60px; background-color: #f8f9fa;">
                                    <div class="text-muted text-center">
                                        <i class="fa fa-info-circle"></i> Selecione um cliente para carregar as tags...
                                    </div>
                                </div>
                                <small class="form-text text-muted">
                                        ...
                                        <div class="tab-content" id="fontesTabContent">
                                            <div class="tab-pane fade show active" id="web-fontes" role="tabpanel" aria-labelledby="web-fontes-tab">
                                                ...
                                                <div id="fontes-web-container" class="border rounded p-3" style="min-height: 120px; max-height: 200px; overflow-y: auto; background-color: #f8f9fa;">
                                                    <div class="text-muted text-center">
                                                        <i class="fa fa-info-circle"></i> Selecione um cliente para carregar as fontes web...
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="impresso-fontes" role="tabpanel" aria-labelledby="impresso-fontes-tab">
                                                ...
                                                <div id="fontes-impresso-container" class="border rounded p-3" style="min-height: 120px; max-height: 200px; overflow-y: auto; background-color: #f8f9fa;">
                                                    <div class="text-muted text-center">
                                                        <i class="fa fa-info-circle"></i> Selecione um cliente para carregar os jornais...
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="tv-fontes" role="tabpanel" aria-labelledby="tv-fontes-tab">
                                                ...
                                                <div id="fontes-tv-container" class="border rounded p-3" style="min-height: 120px; max-height: 200px; overflow-y: auto; background-color: #f8f9fa;">
                                                    <div class="text-muted text-center">
                                                        <i class="fa fa-info-circle"></i> Selecione um cliente para carregar as emissoras/programas de TV...
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="radio-fontes" role="tabpanel" aria-labelledby="radio-fontes-tab">
                                                ...
                                                <div id="fontes-radio-container" class="border rounded p-3" style="min-height: 120px; max-height: 200px; overflow-y: auto; background-color: #f8f9fa;">
                                                    <div class="text-muted text-center">
                                                        <i class="fa fa-info-circle"></i> Selecione um cliente para carregar as emissoras/programas de rádio...
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-12" id="sentimento-section" style="display: none;">
                        ...
                        <div class="col-md-12" id="sentimento-relatorio-section" style="display: none;">
                            <div class="form-group">
                                <label class="form-label fw-semibold mb-2">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2" id="tipos-midia-container">
                            ...
                            <div class="alert alert-info">
                                ...
                                <strong>Selecione um cliente</strong> para carregar os tipos de mídia disponíveis.
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    // Event delegation para tags e fontes (remover onclick inline)
    $(document).on('click', '.tag-filter-item', function() {
        var tag = $(this).data('tag');
        toggleTagFilterSafe(this, tag);
    });

    $(document).on('click', '.fonte-filter-item', function() {
        var tipo = $(this).data('tipo');
        var fonteId = $(this).data('fonte-id');
        var fonteNome = $(this).data('nome-display') || '';
        var subtipo = $(this).data('subtipo') || null;
        toggleFonteFilterSafe(this, tipo, fonteId, fonteNome, subtipo);
    });

    // Versões seguras das funções toggle
    function toggleTagFilterSafe(element, tag) {
        var $element = $(element);
    ...
    function toggleFonteFilterSafe(element, tipo, fonteId, fonteNome, subtipo) {
        var $element = $(element);
        if ($element.hasClass('selected')) {
            $element.removeClass('selected');
        } else {
    ...
    // ===== DEFINIÇÕES DE FUNÇÕES NO ESCOPO GLOBAL =====
    
    // Carregar tags disponíveis para cliente específico (versão unificada)
    function carregarTagsDisponiveisCliente(clienteId) {
        console.log('Carregando tags disponíveis para cliente:', clienteId);
            ...
            success: function(response) {
                ...
                if (response && Array.isArray(response) && response.length > 0) {
                    response.forEach(function(tag) {
                        // Usar event delegation - remover onclick inline
                        tagsHtml += '<span class="tag-filter-item" data-tag="' + escapeHtml(tag) + '">';
                        tagsHtml += '<i class="fa fa-tag mr-1"></i>' + escapeHtml(tag);
                        tagsHtml += '</span>';
                    });
                } else {
                    tagsHtml = '<div class="text-muted text-center">Nenhuma tag encontrada para este cliente</div>';
                }
    ...
    // Carregar todas as fontes disponíveis para cliente específico (versão unificada)
    function carregarFontesDisponiveisCliente(clienteId) {
        console.log('Carregando fontes disponíveis para cliente:', clienteId);
        
        // Carregar fontes web
        carregarFontesWebCliente(clienteId);
        
        // Carregar fontes impresso
        carregarFontesImpressoCliente(clienteId);
        
        // Carregar fontes TV
        carregarFontesTvCliente(clienteId);
        
        // Carregar fontes Rádio
        carregarFontesRadioCliente(clienteId);
    }

    // Carregar fontes Web para cliente específico
    function carregarFontesWebCliente(clienteId) {
        $.ajax({
            ...
            success: function(response) {
                console.log('Fontes web carregadas para cliente:', response);
                    ...
                    if (response && response.success === false) {
                        ...
                        response.forEach(function(fonte, index) {
                            try {
                                ...
                                // Usar event delegation - remover onclick inline
                                fontesHtml += '<span class="fonte-filter-item" data-tipo="web" data-fonte-id="' + fonteId + '" data-nome="' + escapeHtml(fonteNome.toLowerCase()) + '" data-nome-display="' + escapeHtml(fonteNome) + '">';
                                fontesHtml += '<i class="fa fa-globe mr-1"></i>' + escapeHtml(fonteNome);
    ...
    // Carregar fontes Impresso para cliente específico
    function carregarFontesImpressoCliente(clienteId) {
        $.ajax({
            ...
            success: function(response) {
                console.log('Fontes impresso carregadas para cliente:', response);
                ...
                if (response && Array.isArray(response) && response.length > 0) {
                    response.forEach(function(fonte) {
                        // Usar event delegation - remover onclick inline  
                        fontesHtml += '<span class="fonte-filter-item" data-tipo="impresso" data-fonte-id="' + fonte.id + '" data-nome="' + escapeHtml(fonte.nome.toLowerCase()) + '" data-nome-display="' + escapeHtml(fonte.nome) + '">';
                        fontesHtml += '<i class="fa fa-newspaper-o mr-1"></i>' + escapeHtml(fonte.nome);
    ...
    // Carregar fontes TV para cliente específico
    function carregarFontesTvCliente(clienteId) {
        $.ajax({
            ...
            success: function(response) {
                console.log('Fontes TV carregadas para cliente:', response);
                ...
                if (response && Array.isArray(response) && response.length > 0) {
                    response.forEach(function(fonte) {
                        ...
                        fontesHtml += '<span class="fonte-filter-item ' + tipoClass + '" data-tipo="tv" data-subtipo="' + fonte.tipo + '" data-fonte-id="' + fonte.id + '" data-nome="' + escapeHtml(fonte.nome.toLowerCase()) + '" data-nome-display="' + escapeHtml(fonte.nome) + '">';
                        fontesHtml += '<i class="fa ' + icone + ' mr-1"></i>' + escapeHtml(fonte.nome);
                        if (fonte.total_noticias) {
                            fontesHtml += ' <small class="badge badge-light ml-1">(' + fonte.total_noticias + ')</small>';
                        }
                        fontesHtml += '</span>';
    ...
    // Carregar fontes Rádio para cliente específico
    function carregarFontesRadioCliente(clienteId) {
        $.ajax({
            ...
            success: function(response) {
                console.log('Fontes rádio carregadas para cliente:', response);
                ...
                if (response && Array.isArray(response) && response.length > 0) {
                    response.forEach(function(fonte) {
                        ...
                        fontesHtml += '<span class="fonte-filter-item ' + tipoClass + '" data-tipo="radio" data-subtipo="' + fonte.tipo + '" data-fonte-id="' + fonte.id + '" data-nome="' + escapeHtml(fonte.nome.toLowerCase()) + '" data-nome-display="' + escapeHtml(fonte.nome) + '">';
                        fontesHtml += '<i class="fa ' + icone + ' mr-1"></i>' + escapeHtml(fonte.nome);
                        if (fonte.total_noticias) {
                            fontesHtml += ' <small class="badge badge-light ml-1">(' + fonte.total_noticias + ')</small>';
                        }
    ...
    $('#id_cliente').on('change', function() {
        ...
        // Mostrar loading
        $('#tipos-midia-container').html('<label class="form-label fw-semibold mb-2">Clipagem por tipo de mídia</label><div class="text-muted"><i class="fa fa-spinner fa-spin"></i> Carregando configurações do cliente...</div>');
        ...
        $.ajax({
            ...
            success: function(config) {
                ...
                // Mostrar/ocultar seções baseado nas flags
                toggleSecoesPorPermissoes(config);
                ...
                console.log('Cliente configurado com sucesso:', {
                    id: clienteId,
                    areas: config.fl_areas,
                    sentimento: config.fl_sentimento,
                    retorno: config.fl_retorno_midia,
                    print: config.fl_print
                });
            },
            error: function(xhr, status, error) {
                console.error('Erro ao carregar configurações:', error);
                $('#tipos-midia-container').html('<div class="alert alert-danger">Erro ao carregar configurações do cliente.</div>');
                resetarFormulario();
            }
        });
    });
    
    // Flags para controle de visibilidade (inicializadas como false, serão atualizadas dinamicamente)
    window.mostrarAreas = false;
    window.mostrarSentimento = false;
    window.mostrarRetornoMidia = false;
    ...
    function resetarFormulario() {
        ...
        // Resetar tipos de mídia
        $('#tipos-midia-container').html(
            '<label class="form-label fw-semibold mb-2">Clipagem por tipo de mídia</label>' +
            '<div class="alert alert-info">' +
            '<i class="fa fa-info-circle"></i> ' +
            '<strong>Selecione um cliente</strong> para carregar os tipos de mídia disponíveis.' +
            '</div>'
    ...
    // Função para carregar tipos de mídia do cliente
    function carregarTiposMidiaCliente(config) {
        var html = '<label class="form-label fw-semibold mb-2">Clipagem por tipo de mídia</label>';
        html += '<div class="d-flex flex-wrap gap-2">';
        
        if (config.fl_impresso) {
        ...
        if (!config.fl_impresso && !config.fl_web && !config.fl_radio && !config.fl_tv) {
    ...
    $( document ).ready(function() {
        ...
        function pesquisarNoticias() {
            ...
            if (!clienteId) {
                alert('Por favor, selecione um cliente antes de pesquisar.');
                return;
            }
            ...
            var formData = {
                ...
                areas: [],
                cliente: clienteId // Adicionar cliente ID aos dados
            };
                ...
                noticiasArray.forEach(function(noticia) {
                    ...
                    if (noticia && (noticia.id !== undefined && noticia.id !== null)) {
                        ...
                        if (tipo === 'tv' || tipo === 'radio') {
                            ...
                            html += '<strong>' + (noticia.titulo || 'Sem título') + '</strong></td>';
                            html += '<td>' + (noticia.veiculo || 'N/A') + '</td>';
                        }
        ...
        // Carregar tags disponíveis para filtro (versão para cliente logado)
    ...
    // Carregar todas as fontes disponíveis (versão cliente logado)
    ...
    // Definições das funções movidas para o início do documento para evitar erros de referência
    ...
    // Funções de fontes para cliente específico foram movidas para o início do documento
