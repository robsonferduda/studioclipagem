        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    {!! Form::open(['id' => 'frm_social_search', 'class' => 'form-horizontal', 'url' => ['monitoramentos']]) !!}
                                    ...
                                    <div class="card-footer ">
                                        ...
                                        <div class="stats">
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <a title="Clonar Monitoramento" href="{{ url('monitoramento/clonar/'.$monitoramento->id) }}" class="btn btn-default btn-fill btn-icon btn-sm" style="border-radius: 30px; background: #59ceef;">
