...
@section('content')
<div class="col-md-12">
    {!! Form::open(['id' => 'frm_area_cadastrar', 'url' => ['tag']]) !!}
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title ml-3"><i class="fa fa-hashtag"></i> Tags
                        <i class="fa fa-angle-double-right" aria-hidden="true"></i> Cadastrar</h4>
                    </div>
                    <div class="col-md-6">
                        <a href="{{ url('tags') }}" class="btn btn-primary pull-right" style="margin-right: 12px;"><i class="fa fa-hashtag"></i> Tags</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
