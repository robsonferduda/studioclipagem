...
Route::middleware(['web'])->group(function () {
	...
	Route::get('cliente/dashboard','ClienteController@dashboard');
	Route::get('cliente/dashboard/dados','ClienteController@dadosDashboard');
	...
	Route::get('instagram/posts-clientes', 'InstagramController@listarPostagensAjax');
	...
	Route::get('noticia/web/fontes-pendentes', 'NoticiaWebController@fontesPendentesAjax');
	Route::get('noticia/web/noticias-pendentes', 'NoticiaWebController@noticiasPendentesAjax');
	...
	Route::post('noticia-web/imagem-temporaria','NoticiaWebController@imagemTemporaria');
