...
class PDFGenerator:
    ...
    def generate_report(self, noticias_data: pd.DataFrame, valores_data: pd.DataFrame, 
        ...
        # Verifica se deve mostrar seções de retorno
        retorno_filtros = filtros.get('retorno', []) if filtros else []
        mostrar_secoes_retorno = 'com_retorno' in retorno_filtros
        
        # NOVA VERIFICAÇÃO: Se 'sem_retorno' está selecionado, não exibir valores
        mostrar_valores = 'sem_retorno' not in retorno_filtros
        ...
        if noticias_chart_buffer and valores_chart_buffer:
            ...
            if mostrar_valores:
                ...
                no_valores_msg = Paragraph(
                    "Seção de valores oculta - Filtro 'Sem Retorno' selecionado", 
                    self.normal_style
                )
        ...
        if database_manager and mostrar_secoes_retorno:
            ...
            if not mostrar_secoes_retorno:
                ...
                info_text = Paragraph(
                    "As seções de retorno foram ocultadas conforme filtro 'Sem Retorno' aplicado.<br/>"
