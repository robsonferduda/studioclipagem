...
class WebCron4 extends Command
{
    protected $signature = 'web_4:cron';
    ...
    {
        $data['dados'] = null;
        $titulo = " Notificação de Monitoramento Web - Grupo 4 - ".date("d/m/Y H:i:s"); 

        app('App\Http\Controllers\MonitoramentoController')->executarWeb(4);
