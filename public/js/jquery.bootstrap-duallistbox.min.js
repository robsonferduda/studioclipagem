...
(function(factory) {
    ...
    var pluginName = 'bootstrapDualListbox',
      defaults = {
        ...
        infoTextFiltered: 'Filtrados {0} de {1}', // when not all of the options are visible due to the filter
    ...
    BootstrapDualListbox.prototype = {
      init: function () {
        ...
        this.container = $('' +
          ...
          '     <button type="button" class="btn btn-sm clear1" style="float:right!important; margin-top: -10px;"></button>' +
          '   </span>' +
